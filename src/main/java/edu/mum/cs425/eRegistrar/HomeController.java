...
public class HomeController {
	...
	public String homePage(Model model) {
		studentService.save(new Student("000-61-0001", "Anna", "Lynn", "Smith", 3.45f,  new java.util.Date(2019,12,12), true));
		studentService.save(new Student("000-61-0002", "Romuald", "Kamou", "Pogo", 3.85f,  new java.util.Date(2019,12,12), true));
